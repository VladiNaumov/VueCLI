...
src/chapter-01 создание компонента. (project "NEWS NOW" start)
...
src/chapter-02 создание компонента (добавление логики): кнопка прочитать новость, кнопка не прочесть новость, счетчик прочитанных новостей. 
